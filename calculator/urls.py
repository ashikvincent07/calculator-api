...
from operation.views import AdditionView, MultiplicationView, SubtractionView, DivisionView, CubeView, FactorialView, SquareView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('add/', AdditionView.as_view()),
    path('multiply/', MultiplicationView.as_view()),
    path('difference/', SubtractionView.as_view()),
    path('divide/', DivisionView.as_view()),
    path('cube/', CubeView.as_view()),
    path('factorial/', FactorialView.as_view()),
    path('square/', SquareView.as_view())
]
